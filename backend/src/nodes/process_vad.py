...
def process_vad(data: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    speech_timestamps = _get_speech_timestamps(tensor_audio, _vad_model, sampling_rate=sr)
    ...
    for ts in speech_timestamps:
        ...
        if current_chunk_start == -1:
            ...
            if merged_duration > max_length_samples:
                ...
                _flush_chunk(
                    chunks, audio_full, sr,
                    current_chunk_start, current_chunk_end,
                    min_length_samples, max_length_samples
                )
