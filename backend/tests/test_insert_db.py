...
def mock_supabase(monkeypatch):
    ...
    mock_storage.get_public_url.return_value = "https://mock.supabase.co/storage/v1/object/public/audio_chunks/test_ds/fake_uuid.wav"
...
def test_insert_db_success(mock_uuid, mock_supabase):
    ...
    assert insert_payload["audio_url"] == "https://mock.supabase.co/storage/v1/object/public/audio_chunks/test_ds/fake_uuid.wav"
